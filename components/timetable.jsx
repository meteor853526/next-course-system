const table = () => {
    return <table className="border-separate border border-slate-400 center">
                <thead>
                <tr>
                    <th className="border border-slate-300 ...">星期一</th>
                    <th className="border border-slate-300 ...">星期二</th>
                    <th className="border border-slate-300 ...">星期三</th>
                    <th className="border border-slate-300 ...">星期四</th>
                    <th className="border border-slate-300 ...">星期五</th>
